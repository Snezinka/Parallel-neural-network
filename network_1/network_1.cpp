...
int main()
{
    ...
    double epoch = 5;
    double time_epoch = 0, time_SGD = 0, error_time = 0;
    ...
    for (int p = 1; p < epoch + 1; p++)
    {
        ...
        time_epoch += end - begin;
        double time = end - begin;
        cout << "Epoch: " << time_epoch / p << " s. Back propagation error: " << error_time / (size_mini_batch * count_batch * p) * 1000000 << " s * 10^-6. ";
        cout << "SGD: " << time_SGD / (count_batch * p) * 1000000 << " s * 10^-6." << endl;

    }
    cout << "\nMean time:" << endl;
    cout << "Epoch: " << time_epoch / epoch << " s. Back propagation error: " << error_time / (size_mini_batch * count_batch * epoch) * 1000000 << " s * 10^-6. ";
